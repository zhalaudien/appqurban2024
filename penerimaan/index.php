    ...
    <body class="sb-nav-fixed">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4 text-center">PENERIMAAN QURBAN PUSAT 7</h1>
                <hr>
                <div class="form-row">
                    <div class="col-md">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input id="sapi" name="sapi" type="text" class="form-control"
                                            placeholder="Masukan Jumlah Sapi Yang Diterima">
                                    </div>
                                </div>
                            </div>
                            <div class="my-2">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input id="kambing" name="kambing" type="text" class="form-control"
                                            placeholder="Masukan Jumlah Kambing Yang Diterima">
                                    </div>
                                </div>
                            </div>
                            <div class="my-2">
                        ...
                        <div class="row my-3">
                            <div class="col-md">
                                <table id="datatablesSimple"
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($view_penerimaan as $row) : ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><?= $row['cabang']; ?></td>
                                            <td><?= $row['pengirim']; ?></td>
                                            <td><?= $row['sapi']; ?></td>
                                            <td><?= $row['kambing']; ?></td>
                                            <td>Rp. <?= number_format($row['shadaqoh'], 0, ',', '.'); ?></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="nota.php?id=<?= $row['id']; ?>" type="button" target="_BLANK"
                ...
                <div class="form-row">
                    <div class="col-md">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <a href="export2.php" target="_blank" class="btn btn-success ms-1"><i
                                    class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;Ekspor ke Excel</a>
                        </form>
                    </div>
                </div>
                                ...
                                <table id="datatablesSimple"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['date_input']; ?></td>
                                            <td class="text-center">
                                                <a href="delet2.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm"
                                                    style="font-weight: 600;"
                                                    onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['cabang']; ?> ?');"><i
                                                        class="bi bi-trash-fill"></i>Hapus</a>
                                            </td>
