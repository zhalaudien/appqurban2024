...
<a href="controler/template/kirim_besek.php?id=<?= $row['id']; ?>" class=" btn btn-primary btn-sm"
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class=" my-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="info_kirim" class="form-label">Status</label>
                                <select id="info_kirim" name="info_kirim" class="form-control">
                                    <option value="<?= $row['info_kirim']; ?>"><?= $row['info_kirim']; ?></option>
