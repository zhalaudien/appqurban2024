...
if (isset($_POST['update'])) {
    if (update_amprah($_POST) > 0) {
        echo "<script>
                alert('Data cabang berhasil diubah!');
                document.location.href = 'amprah_data.php';
            </script>";
    } else {
    ...
    ?>
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Data Amprah Besek Cabang</h1>
                        <br>
                                ...
                                <div class="row my-3">
                                    <div class="col-md">
                                        <table id="datatablesSimple"
                                            ...
                                            <tbody>
                                                <?php $no = 1; ?>
                                                <?php foreach ($view_amprah as $row) : ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $row['cabang']; ?></td>
                                                    <td><?= $row['p_ts']; ?></td>
                                                    ...
                                                    <td><?= $row['info']; ?></td>
                                                    <td>
                                                        <a><?php include 'controler/detail_amprah.php'; ?></a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>
                                            </tbody>
